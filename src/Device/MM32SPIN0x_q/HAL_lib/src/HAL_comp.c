...
==============================================================================
[..]
The device integrates 1 analog comparators COMP1:
...
void COMP_DeInit(uint32_t COMP_Selection)
{
    if (COMP_Selection > COMP_Selection_COMP1) {
        COMP_Selection = COMP_Selection_COMP1;
    }
...
{
    COMP_InitStruct->COMP_InvertingInput = COMP_InvertingInput_IO0;
    COMP_InitStruct->COMP_NonInvertingInput = COMP_NonInvertingInput_IO0;
