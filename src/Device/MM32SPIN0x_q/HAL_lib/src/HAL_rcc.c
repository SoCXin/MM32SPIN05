...
* @arg RCC_SYSCLKSource_HSI_DIV6: HSI divided by 6 selected as system clock
* @arg RCC_SYSCLKSource_HSE: HSE selected as system clock
* @arg RCC_SYSCLKSource_HSI: HSI selected as system clock
* @arg RCC_SYSCLKSource_LSI: LSI selected as system clock
* @retval : None
*/
...
void RCC_GetClocksFreq(RCC_ClocksTypeDef *RCC_Clocks)
{
    ...
    if ( 0x04 == tmp ) {
        ...
        tmp = RCC->CR;
        if ((tmp & (1 << 20)) == 0x00) {
            RCC_Clocks->SYSCLK_Frequency = 48000000;
        } else {
        ...
        tmp = RCC->CR;
        if ((tmp & (1 << 20)) == 0x00) {
            RCC_Clocks->SYSCLK_Frequency = 48000000 / 6;
        } else {
            RCC_Clocks->SYSCLK_Frequency = 72000000 / 6;
        }
    }
...
* @arg RCC_AHBPeriph_FC
* @arg RCC_AHBPeriph_CRC
* @arg RCC_AHBPeriph_GPIOA
* @arg RCC_AHBPeriph_GPIOB
* @arg RCC_AHBPeriph_GPIOC
* @arg RCC_AHBPeriph_GPIOD
* @arg RCC_AHBPeriph_HIV
*   SRAM and FC clock can be disabled only during sleep mode.
...
*   clock.
*   This parameter can be any combination of the following values:
* @arg RCC_APB2Periph_SYSCFG, RCC_APB2Periph_ADC,
*   RCC_APB2Periph_TIM1,
*   RCC_APB2Periph_CPT, RCC_APB2Periph_TIM14,
*   RCC_APB2Periph_TIM16, RCC_APB2Periph_TIM17, RCC_APB2Periph_DBG,
*   RCC_APB2Periph_PWM, RCC_APB2Periph_ALL
* @param NewState: new state of the specified peripheral clock.
*   This parameter can be: ENABLE or DISABLE.
* @retval : None
*/
...
*   RCC_APB1Periph_UART2, RCC_APB1Periph_I2C,
...
*   This parameter can be any combination of the following values:
* @arg RCC_APB1Periph_TIM2, RCC_APB1Periph_TIM3,
*   RCC_APB1Periph_WWDG, RCC_APB1Periph_SPI
*   RCC_APB1Periph_UART, RCC_APB1Periph_I2C,
*   RCC_APB1Periph_PWR, RCC_APB1Periph_ALL
* @param NewState: new state of the specified peripheral clock.
*   This parameter can be: ENABLE or DISABLE.
* @retval : None
...
* @arg RCC_MCO_HSI_Div4: HSI oscillator clock divided by 4 selected
