...
#ifndef __MM32SPIN0x_q_H
#define __MM32SPIN0x_q_H
...
#define __MM32SPIN0x_q_STDPERIPH_VERSION_MAIN (0x01)
/*!< [15:8]   Standard Peripheral Library sub1 version */
#define __MM32SPIN0x_q_STDPERIPH_VERSION_SUB1 (0x00)
/*!< [7:0]   Standard Peripheral Library sub2 version */
#define __MM32SPIN0x_q_STDPERIPH_VERSION_SUB2 (0x00)
/*!< Standard Peripheral Library version number */
#define __MM32SPIN0x_q_STDPERIPH_VERSION ((__MM32SPIN0x_q_STDPERIPH_VERSION_MAIN << 16) | (__MM32SPIN0x_q_STDPERIPH_VERSION_SUB1 << 8) | __MM32SPIN0x_q_STDPERIPH_VERSION_SUB2)
...
typedef struct {
    __IO uint32_t COMP1_CSR;  //0x00 /*!< Comparator control Status register, Address offset: 0x00 */
    ...
    __IO uint32_t COMP1_POLL; //0x1C
    __IO uint32_t RESERVED5;  //0x20
} COMP_TypeDef;
/**
* @}
*/
...
#define COMP_CSR_MODE                         ((uint32_t)0x0000000C)               /*!<Comparator mode*/
