...
#define ROTOR_IPD1_TARGET_CURRENT       1  //unit:0.1A define the target torque current in ROTOR_SMALL_SWING_MODE
...
#define OPEN_LOOP_RAMP_UP_SPEED_SLOP3   300 //90  //unit:RPM/sec,range(1~1000),acceleration slop in open loop 3th stage
...
#define RAMP_UP_CHANGE_TO_SLOP2_SPEED    100 //unit:RPM,define the open loop threshold speed for ramp up slop1 change to slop2
#define RAMP_UP_CHANGE_TO_SLOP3_SPEED    200 //unit:RPM,define the open loop threshold speed for ramp up slop2 change to slop3

#define OPEN_LOOP_TARGET_CURRENT         2//3 //unit:0.1A define the target  torque current in open loop ramp up stage
#define OPEN_LOOP_INITIAL_CURRENT        3//4 //unit:0.1A,define the initial torque current in open loop ramp up stage 
...
#define TARGET_SPEED_1                600 //unit: RPM, define the user's lowest  target speed
#define TARGET_SPEED_2                800 //unit: RPM, define the user's second  target speed
#define TARGET_SPEED_3                900 //unit: RPM, define the user's Third   target speed
#define TARGET_SPEED_4                1000 //unit: RPM, define the user's 4th     target speed
#define TARGET_SPEED_5                1100//1400 //unit: RPM, define the user's 5th     target speed
#define TARGET_SPEED_6                1200//1800 //unit: RPM, define the user's 6th     target speed
#define TARGET_SPEED_7                1500 //unit: RPM, define the user's highest target speed

#define CLOSE_LOOP_RAMP_UP_SPEED_SLOP (TARGET_SPEED_7/3) //unit:RPM/sec,range(1~300),acceleration slop in close loop
#define CLOSE_LOOP_SPEED_TO_STOP_PWM  ((OPEN_LOOP_TARGET_SPEED*2)/2) //unit: RPM,(must > OPEN_LOOP_TARGET_SPEED),if receive motor stop command, pwm will off when speed under this define
...
#ifdef ENABLE_1_SHUNT_R_TO_MEASURE_3_PHASE_CURRENT
#define SMO_Kslf_MAX_VALUE      3600//4600 //recommended value (300~6000), range (1~32767)
#define SMO_Kslf_MIN_VALUE      1200 //recommended value (100~2000), range (1~32767)
#else
#define SMO_Kslf_MAX_VALUE      4600//3600 //recommended value (300~6000), range (1~32767)
#define SMO_Kslf_MIN_VALUE      1200//1800 //recommended value (100~2000), range (1~32767)
#endif
...
#define Id_COMMAND_VALUE            0 //range (-2000~+2000)
...
#define  RESTART_WAIT_TIME_AFTER_PWM_OFF  36//unit: 0.1second, 50 measns wait 5 second after PWM off, then can restart motor
